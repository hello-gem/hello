...
RSpec.bdd.uic "Profile Pages" do

  story "There are many ways to visit the profile pages" do
    ...
    scenario "Via Navigation Bar" do
  ...
  story "Redirects to username" do
    ...
    scenario "Visits username URL" do
