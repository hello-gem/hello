...
RSpec.bdd.uic "Token Expiration" do

  story "Various time spans" do
    scenario "Sustains at 09 minutes" do
    ...
    scenario "Renews at 11 minutes" do
    ...
    scenario "Expires at 31 minutes" do
